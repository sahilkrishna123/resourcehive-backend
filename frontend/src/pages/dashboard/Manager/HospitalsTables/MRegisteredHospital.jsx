...
import DeleteHospital from "./MDeleteHospital"; // Import the new DeleteHospital component
import EditHospital from "./MEditHospital"; // Import the new EditHospital component
